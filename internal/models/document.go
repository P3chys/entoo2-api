...
type Document struct {
	...
	TypeID       *uuid.UUID `gorm:"type:uuid;index;default:null" json:"type_id"`    // FK to DocumentType - nullable for migration
	...
	Type     *DocumentType     `gorm:"foreignKey:TypeID" json:"document_type,omitempty"`
